 ...
 *              ←── 左半边(GP1) ──→ | ←── 右半边(GP2) ──→
 * 
 * 物理行1:  GP3    GP8    GP13  |  GP3   (空)   (空)
 * 物理行2:  GP4    GP9    GP14  |  GP4    GP9    GP14
 * 物理行3:  GP5    GP10   GP15  |  GP5    GP10   GP15
 * 物理行4:  GP6    GP11   GP16  |  GP6    GP11   GP16
 * 物理行5:  GP7    GP12   GP17  |  GP7    GP12   GP17
 * 
 * 拇指区（从左到右）：GP18, GP19, GP20, GP21, GP22, GP26
 */
...
// 矩阵列引脚（15根）
// 右手列线顺序（从左到右）：每行是 GP3/4/5/6/7, GP8/9/10/11/12, GP13/14/15/16/17
static const pin_t col_pins[] = { 
    GP3,  GP8,  GP13,   // 物理行0的列线
